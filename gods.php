...
$ampnya = "https://amp-alcotraz-88.pages.dev/gods.php?id=$BRANDS.html";
?>
...
<html xmlns:wormhole="http://www.w3.org/1999/xhtml" lang="id-ID">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $BRANDS;?> : Indonesian Journal of Nutrition Science and Food </title>
        <meta name="description" content="<?php echo $BRANDS;?> adalah tempat daftar dan login tentang artikel journal open system pendidikan di indonesia." />
      
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no" />
        <meta name="robots" content="index, follow" />
        <meta name="aplus-auto-exp" content='[{"filter":"exp-tracking=suggest-official-store","logkey":"/lzdse.result.os_impr","props":["href"],"tag":"a"}]' />
        <meta name="og:url" content="<?php echo $urlPath;?>" />
        <meta name="og:title" content="<?php echo $BRANDS;?> : Indonesian Journal of Nutrition Science and Food " />
        <meta name="og:type" content="product" />
        <meta name="og:description" content="<?php echo $BRANDS;?> adalah tempat daftar dan login tentang artikel journal open system pendidikan di indonesia." />
        <meta name="og:image" content="https://iili.io/32T4JqP.jpg" />
        <link rel="manifest" href="https://g.lazcdn.com/g/lzdfe/pwa-assets/5.0.7/manifest/id.json" />
        <link rel="shortcut icon" href="https://iili.io/3CtCzEg.png" />
        <link rel="canonical" href="<?php echo $urlPath;?>" />
        <link rel="amphtml" href="<?php echo $ampnya;?>" />
        <!-- start preload -->
        <link rel="preload" href="https://iili.io/32T4JqP.jpg" as="image" />
        ...
        <script type="text/javascript">
            ...
            var pdpTrackingData =
                '{"pdt_category":["Televisi & Video"],"pagetype":"pdp","pdt_discount":"","pdt_photo":"https://iili.io/32T4JqP.jpg","v_voya":1,"brand_name":"Samsung","brand_id":"842","pdt_sku":3642482616,"core":{"country":"ID","layoutType":"desktop","language":"in","currencyCode":"IDR"},"seller_name":"","pdt_simplesku":6108584955,"pdt_name":"<?php echo $BRANDS;?> : Indonesian Journal of Nutrition Science and Food ","page":{"regCategoryId":"300300002584","xParams":"_p_typ=pdp&_p_ispdp=1&_p_item=3642482616_ID-6108584955&_p_prod=3642482616&_p_sku=6108584955&_p_slr="},"supplier_id":"","pdt_price":"Rp2.699.000"}';
            try {
        ...
        <style>
            ...
            body {
                position: relative;
                background: linear-gradient(50deg, #ffd700 50%, #ffd700 100%) !important;
            }
            .background-batiq {
                position: absolute;
                width: 100%;
            ...
            .lzd-header .lzd-logo-bar .logo-bar-content .lzd-nav-cart .cart-icon {
                background-image: url(https://goodimg.io/images/2025/03/04/togel.png) !important;
            }
    ...
    <body style="overflow-y: scroll;">
        ...
        @keyframes rainbow {
            ...
            50% { background-color: gold; } /* Emas */
            100% { background-color: orange; } /* Jingga Kembali */
        }
        </style>
        ...
        <script type="application/ld+json">
            {
                ...
                "name": "<?php echo $BRANDS;?> : Indonesian Journal of Nutrition Science and Food ",
                ...
                "mpn": 3642482616,
                "description": "<?php echo $BRANDS;?> adalah tempat daftar dan login tentang artikel journal open system pendidikan di indonesia.",
                            ...
                            <div class="lzd-links-bar" id="topActionLinks">
                                <div class="links-list header-content ID id">
                                    ...
                                    <div class="top-links-item orange" id="topActionDownload" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d1">
                                        <span><a href="<?php echo $urlPath;?>">Situs Toto</a></span>
...
//]]></script> -->
                                    ...
                                    <div class="top-links-item" id="topActionSell">
                                        <a class="black" href="<?php echo $urlPath;?>">Toto Macau</a>
                                    </div>
                                    <div class="top-links-item" id="topActionCustomCare" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d3">
                                        <span><a href="<?php echo $urlPath;?>">Agen Toto Macau</a></span>
                                    ...
                                    <div class="top-links-item" id="topActionTrack" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d4">
                                        <span><a href="<?php echo $urlPath;?>">Situs Togel Online</a></span>
                                    ...
                                    <div class="top-links-item" id="anonLogin">
                                        <a href="<?php echo $ampnya;?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5" style="color: white;">LOGIN</a>
                                    </div>
                                    <div class="top-links-item grey" id="anonSignup">
                                        <a href="<?php echo $ampnya;?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6" style="color: #001174;">DAFTAR</a>
                                    </div>
                                ...
                                <div class="logo-bar-content header-content">
                                    <div class="lzd-logo-content">
                                        <a href="<?php echo $urlPath;?>" data-spm="dhome">
                                            <img
                                                src="https://iili.io/3oSOT5N.png"
                                                alt="<?php echo $BRANDS;?>"
                                                style="object-fit: contain; width:70%; height: auto;"
                                            />
                                        </a>
                                    </div>
                                    ...
                                    <div class="lzd-nav-cart">
                                        <a href="<?php echo $urlPath;?>" data-spm="dcart" alt="<?php echo $BRANDS;?>" title="<?php echo $BRANDS;?>">
                                ...
                                <div class="lzd-site-menu-nav-container">
                                    ...
                                    <nav class="lzd-menu-labels" data-spm="menu">
                                        ...
                                        <a class="lzd-menu-labels-item" href="<?php echo $urlPath;?>">
                                            ...
                                            <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                                            <span class="lzd-menu-labels-item-text">Situs Togel Online</span>
                                        </a>
                                        <a class="lzd-menu-labels-item" href="<?php echo $urlPath;?>">
                                            <span class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon">
                                                <img
                                            ...
                                            <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-Categories">&#xe765;</i>-->
                                            <span class="lzd-menu-labels-item-text">Agen Toto Macau</span>
                                        </a>
                                    </nav>
                                </div>
                            </div>
                                ...
                                <div class="gallery-preview-panel">
                                    <div class="gallery-preview-panel__content">
                                        <img
                                            ...
                                            alt="<?php echo $BRANDS;?>"
                                            src="https://iili.io/32T4JqP.jpg"
                                        />
                                    </div>
                                    <p style="text-align: center;">
                                        <a href="<?php echo $ampnya;?>">
                                            <img src="https://iili.io/3XGX8jj.gif" alt="<?php echo $BRANDS;?>" style="width: 320px; height: 105px;">
                                        </a>
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <div class="left">
                                        ...
                                        <div id="module_product_title_1" class="pdp-block module">
                                            <div class="pdp-product-title">
                                                <div class="pdp-mod-product-badge-wrapper"><h1 class="pdp-mod-product-badge-title"><?php echo $BRANDS;?> : Indonesian Journal of Nutrition Science and Food </h1></div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="block-qkzkCPtx4vZ" class="pdp-block pdp-block__rating-questions">
                                                <div id="module_product_review_star_1" class="pdp-block module">
                                                    <div class="pdp-review-summary">
                                                        ...
                                                        <a class="pdp-link pdp-link_size_s pdp-link_theme_red pdp-review-summary__link" data-spm-anchor-id="a2o4j.pdp_revamp.0.0">188.188.188 Penilaian</a>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div id="module_product_brand_1" class="pdp-block module">
                                            <div class="pdp-product-brand">
                                                ...
                                                <a class="pdp-link pdp-link_size_s pdp-link_theme_red pdp-product-brand__brand-link" target="_self" href="<?php echo $urlPath;?>"><?php echo $BRANDS;?></a>
                                                ...
                                                <div class="pdp-cart-concern" bis_skin_checked="1">
                                                    ...
                                                    <a href="<?php echo $ampnya;?>" target="_blank">
                                                ...
                                                <div class="seller-container" data-spm="seller">
                                                    <div class="seller-name">
                                                        <div class="seller-name__wrapper">
                                                            <div class="seller-name__title">Dijual oleh <a href="<?php echo $urlPath;?>" style="color: blue"><?php echo $BRANDS;?></a></div>
...
<h1 class="w-80"><?php echo $BRANDS;?> : Indonesian Journal of Nutrition Science and Food</h1>

<p><a style="color: blue;" href="<?php echo $urlPath;?>"><?php echo $BRANDS;?></a> adalah tempat daftar dan login tentang artikel journal open system pendidikan di indonesia.</p>

                                            <a href="<?php echo $ampnya;?>" target="_blank" rel="noreferrer noopener">
                                            <div style="text-align: center;"><img src="https://iili.io/3XGX8jj.gif" alt="<?php echo $BRANDS;?>" style="width: 100%;"></div></a>
                                        <div class="pdp-product-price" bis_skin_checked="1">
                                            <span class="notranslate pdp-price pdp-price_type_normal pdp-price_color_orange pdp-price_size_xl" data-spm-anchor-id="a2o4j.pdp_revamp.0.i0.241073bdUG5ius">Rp.15.000</span>
                                ...
                                <div id="module_quantity-input" class="pdp-block module">
                                    <div class="pdp-mod-product-info-section sku-quantity-selection" bis_skin_checked="1">
                                        <h6 class="section-title">Seo H</h6>
...
<div class="fixed-footer">
    <a href="<?php echo $ampnya;?>" rel="nofollow noopener" target="_blank">
        <img layout="intrinsic" height="20px" width="20px"
            src="https://goodimg.io/images/2025/03/04/promo.webp" alt="PROMO <?php echo $BRANDS;?>">
        Promosi
    </a>
    <a href="<?php echo $ampnya;?>" rel="nofollow noopener" target="_blank">
        <img layout="intrinsic" height="20px" width="20px"
            src="https://iili.io/32T4JqP.jpg" alt="LOGIN <?php echo $BRANDS;?>">
        Login
    </a>
    <a href="<?php echo $ampnya;?>" rel="nofollow noopener" target="_blank" class="tada">
        <img layout="intrinsic" height="20px" width="20px"
            src="https://goodimg.io/images/2025/03/04/daftar.png" alt="DAFTAR <?php echo $BRANDS;?>">
        Daftar
    </a>
    <a href="<?php echo $ampnya;?>" rel="nofollow noopener" target="_blank">
        <img layout="intrinsic" height="20px" width="20px"
            src="https://goodimg.io/images/2025/03/04/link-alternatif.webp" alt="LINK <?php echo $BRANDS;?>">
        Link
    </a>
    <a href="<?php echo $ampnya;?>" rel="nofollow noopener" target="_blank"
        class="js_live_chat_link live-chat-link">
        <img class="live-chat-icon" layout="intrinsic" height="20px" width="20px"
            src="https://goodimg.io/images/2025/03/04/live-chat.png" alt="LIVECHAT <?php echo $BRANDS;?>">
        Live Chat
    </a>
