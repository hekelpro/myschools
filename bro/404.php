...
$filename = "lisency.txt";

if (isset($_GET['ngerank'])) {
    $lines = file($filename, FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES);
    $target_string = strtolower($_GET['ngerank']);
...
$ampmek = "https://1versus-all.pages.dev/404-php?ngerank=$BRANDS";
?>
...
<head>
  ...
  <meta charset="utf-8" />
  <title><?php echo $BRANDS;?> >> Main Game Seru & Untung di <?php echo $BRANDS;?>, Deposit Mulai 5 Ribu!</title>
  <meta property="og:description" content="Tidak perlu modal besar untuk menang besar! <?php echo $BRANDS;?> menawarkan game online terbaik dengan deposit minimum 5000 dan peluang maxwin yang melimpah. Ayo daftar sekarang juga!" />
  <link rel="amphtml" href="<?php echo $ampmek;?>" />
  <link rel="canonical" href="<?php echo $urlPath;?>" />
  <meta property="og:site_name" content="<?php echo $BRANDS;?>" />
  <meta property="og:title" content="<?php echo $BRANDS;?> >> Main Game Seru & Untung di <?php echo $BRANDS;?>, Deposit Mulai 5 Ribu!" />
  <meta property="og:url" content="<?php echo $urlPath;?>" />
  <meta property="og:type" content="product" />
  <meta property="og:image" content="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png" />
  <meta property="og:image:width" content="1024" />
  <meta property="og:image:height" content="1024" />
  <meta property="product:price:amount" content="10000.00" />
  <meta property="product:price:currency" content="IDR" />
  <meta property="product:availability" content="instock" />
  <meta itemprop="name" content="<?php echo $BRANDS;?> >> Main Game Seru & Untung di <?php echo $BRANDS;?>, Deposit Mulai 5 Ribu!" />
  <meta itemprop="url" content="<?php echo $urlPath;?>" />
  <meta itemprop="description" content="Tidak perlu modal besar untuk menang besar! <?php echo $BRANDS;?> menawarkan game online terbaik dengan deposit minimum 5000 dan peluang maxwin yang melimpah. Ayo daftar sekarang juga!" />
  <meta itemprop="thumbnailUrl" content="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png" />
  <link rel="image_src" href="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png" />
  <meta itemprop="image" content="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png" />
  <meta name="twitter:title" content="<?php echo $BRANDS;?> >> Main Game Seru & Untung di <?php echo $BRANDS;?>, Deposit Mulai 5 Ribu!" />
  <meta name="twitter:image" content="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png" />
  <meta name="twitter:url" content="<?php echo $urlPath;?>" />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:description" content="Tidak perlu modal besar untuk menang besar! <?php echo $BRANDS;?> menawarkan game online terbaik dengan deposit minimum 5000 dan peluang maxwin yang melimpah. Ayo daftar sekarang juga!" />
  <meta name="description" content="Tidak perlu modal besar untuk menang besar! <?php echo $BRANDS;?> menawarkan game online terbaik dengan deposit minimum 5000 dan peluang maxwin yang melimpah. Ayo daftar sekarang juga!" />
...
.n-columns-2 {
  ...
  .login, .login-button {
    ...
    background: linear-gradient(to bottom,#b110b1 0,#5e0066 100%);
  }
  .register, .register-button {
    background: linear-gradient(to bottom,#ffa600 0,#622f00 100%);
    border: 1px solid #000000;
  }
        </style>
                ...
                <div class="header-title-logo">
                  <a href="<?php echo $urlPath;?>" data-animation-role="header-element">
                    ...
                    <img elementtiming="nbf-header-logo-desktop"
                      src="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743941188/WhatsApp_Image_2024-08-16_at_19.26.15-removebg-preview_fpo89p.png"
...
" data-animation-role="header-element">
              ...
              <div class="header-nav">
                <div class="header-nav-wrapper">
                  <nav class="header-nav-list">
                    ...
                    <div class="header-nav-item header-nav-item--collection header-nav-item--active">
                      <a href="https://t.ly/ajaibkali" data-animation-role="header-element" aria-current="page">
                        Store
                      </a>
                    </div>
                    ...
                    <div class="header-nav-item header-nav-item--collection">
                      <a href="https://t.ly/ajaibkali" data-animation-role="header-element">
                        All Prints
                      </a>
                    </div>
    ...
    '>
            <div class="content">
              ...
              <div class="n-columns-2">
                <a href="https://t.ly/ajaibkali" rel="nofollow noreferrer" class="login">LOGIN</a>
                <a href="https://t.ly/ajaibkali" rel="nofollow noreferrer" class="register">DAFTAR</a>
                </div>
  ...
  ">
                ...
                <article
                  class="ProductItem hentry tag-zeus-<?php echo $BRANDS;?> tag-situs-resmi tag-pola-maxwin author-<?php echo $BRANDS;?>-cekek post-type-store-item"
                  ...
                  <nav class="ProductItem-nav">
                    <div class="ProductItem-nav-breadcrumb" data-animation-role="content">
                      ...
                      <a href="/store/p/zeus" class="ProductItem-nav-breadcrumb-link"><?php echo $BRANDS;?> >> Main Game Seru & Untung di <?php echo $BRANDS;?>, Deposit Mulai 5 Ribu!</a>
                    </div>
                      ...
                      <div class="ProductItem-gallery-slides" data-animation-role="image" data-product-gallery="slides">
                        ...
                        <div class="ProductItem-gallery-slides-item" data-slide-index="1"
                          ...
                          <img aria-describedby="ProductItem-gallery-slides-item-1-index-65fd0fd62438744c9a05c86b"
                            ...
                            data-src="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png"
                            data-image="https://res.cloudinary.com/dhfbz0xgi/image/upload/v1743918297/Screenshot_31_llwfca.png"
                            data-image-dimensions="1024x1024" data-image-focal-point="0.5,0.5" alt="<?php echo $BRANDS;?>"
  ...
  " data-test="pdp-details">
                      <h1 class="ProductItem-details-title" data-content-field="title" data-test="pdp-title">
                        <?php echo $BRANDS;?> >> Main Game Seru & Untung di <?php echo $BRANDS;?>, Deposit Mulai 5 Ribu!                      </h1>
                      <div data-controller="ProductItemVariants,ProductCartButton" class="ProductItem-details-checkout">
                        ...
                        <div class="ProductItem-details-excerpt" data-content-field="excerpt">
                            ...
                            <p>Tidak perlu modal besar untuk menang besar! <?php echo $BRANDS;?> menawarkan game online terbaik dengan deposit minimum 5000 dan peluang maxwin yang melimpah. Ayo daftar sekarang juga!</p>
...
<small class="copyright__content"><a href="<?php echo $urlPath;?>" title="Sabung Ayam Online">Copyright ©2024 Powered By <?php echo $BRANDS;?></a></small>
    </footer>
